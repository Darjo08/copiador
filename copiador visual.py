...
class WorkerCopia(QThread):
    ...
    def __init__(self, directorios_origen, directorio_destino, copiar_todo, opciones_copia, texto_reemplazo_rips, texto_sufijo_rips, texto_reemplazo_docker, texto_sufijo_docker, copiar_en_raiz, comprimir_zip, aut_compensar, texto_reemplazo_zip, texto_sufijo_zip, texto_reemplazo_directorios, texto_sufijo_directorios,texto_reemplazo_ad, texto_sufijo_ad, descargar_cuv):
        super().__init__()
...
class CopiadorDirectorios(QMainWindow):
    ...
    def confirmar_copia(self):
        ...
        self.worker_thread = WorkerCopia(
            ...
            texto_reemplazo_ad,
            texto_sufijo_ad,
            self.check_descargar_cuv.isChecked()   # ← Muy importante
        )
